...
const TextHero: React.FC = () => {
  return (
    <div className="w-full relative py-1 md:py-3 lg:py-6">
      {/* Background Image */}
      <div className="absolute inset-0">
        <Image
          src="/images/firemeetsice.jpg"
          alt="Fire meets ice Iceland background"
          fill
      ...
      <div className="relative z-10 flex justify-center items-center min-h-[20vh] md:min-h-[30vh]">
        <div className="w-[92%] md:w-full max-w-7xl md:px-6 lg:px-8 xl:px-12 2xl:px-16">
          <div className="flex flex-col items-center justify-center text-center space-y-1 sm:space-y-4 md:space-y-6 lg:space-y-8 py-2 px-3 sm:px-4 md:py-6 md:px-6 lg:py-8 lg:px-8">
